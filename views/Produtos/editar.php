...
if(isset($_POST) && count($_POST) > 0) {
    ...
    $c->setCategoria_id($_POST['campoCategoria_Id']);
        ...
        <div class="row mt-3">
            ...
            <div class="col-9">
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        <label for="idCategoria_Id" class="form-label">Categoria_Id:</label>
                        <input type="text" class="form-control" name="campoCategoria_Id" 
                            id="idCategoria_Id" value="<?= $dado->getCategoria_id(); ?>">
                    </div>
